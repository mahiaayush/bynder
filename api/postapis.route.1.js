...
postRoutes.route('/jobsbycampaignid/:campaignId').get(function (req, res) {
  ...
  var token=appConfig.getToken();
    ...
    try{
      console.log("JSON DATA IS length is:==>", typeof JobsResult,  JobsResult.length);
    }catch(e){
      console.log("Error is :==>", e)
    }
    //let connection = mysql.createConnection(config);
    ///// ------------------------
    var results=[]; var movedCount=0;
    for(let k=0; k< JobsResult.length; k++){
       
        
      
    //console.log(new Date (JobsResult[k].dateCreated) > new Date("2019-02-25") , JobsResult[k].dateCreated , new Date("2019-02-25"));
     // AVOID before 25-feb-2019 data
     // as discussed with client we have need remove these records
     var avoidJobsID=new Array("adf84a7b-64a3-4315-9713-fdb3f61f691f",
     "156d2215-69bf-4800-aebd-91b80f342e57",
     "dcf9d435-5400-49e1-a204-4010f237a72c",
     "88de0eef-5a29-4c5b-adb1-1306f5bab783",
     "ce7c38df-51da-4045-92c8-1fc035fae8b8",
     "2671a865-dfee-4ea0-830d-ddde2067fa69",
     "0ba370a1-39a8-454b-8353-ac59659fd3ce",
     "2d59f1d8-47a2-493e-bd83-42e3178118ac",
     "08be44fa-5ca2-4def-b213-ff9f5ddf88fe",
     "15379fb4-ded4-4a7b-8d5a-9eb1bc4b173b",
     "2b293143-6b50-4075-aed9-2bc7c8144c9f",
     "e7cc232e-6869-46fa-99bf-250c9334e019",
     "89af2131-2527-4418-80c6-ad3cead118f9",
     "74979e90-20af-40ef-b0d5-5cca1c936aad",
     "b316c54a-8419-4df6-8de2-e0ffa4e6f120",
     "91f3db11-1e0e-41ea-a974-c1d3bd562baa",
     "42da2b82-9a1e-48b5-af73-5a16b035638e",
     "ee305287-f0b1-48ff-ac14-7435dbf2cf4c",
     "a76e8939-becb-4e93-9724-47d8825d96bf",
     "c7b51762-acf8-48ce-9e8f-9d09a2291f93",
     "fe842b52-05cb-4201-bee4-3169fe02b7b4",
     "22d2e518-3597-4e07-94ed-18732c221690",
     "2b8a742d-daca-4c4e-bb60-4c8f2620671f",
     "55234d0a-c0aa-48e6-8374-b41429817138",
     "5af4c49d-1ff0-46cc-904d-0f5f7600900e",
     "97f1ebf4-d35f-46ab-a7c7-b719b39792b1",
     "c284d58c-efea-4a1b-8d29-a674110681f5",
     "e38c76bc-4f4a-421f-9c55-ece7092cf71d",
     "20fb382d-961c-4765-9bfb-46b7d3a9c23e",
     "30087be0-c060-45d7-9231-df75bb73b792",
     "518feaf1-895c-4fcc-895e-d4fe22d3c9fb",
     "37768508-e952-494e-ba15-dcb00b9f658f",
     "5c33feb5-e4cf-4ba0-adb8-5771ab7156f1",
     "498e05b0-6755-4d7d-b20e-0e8493090ad7",
     "6ac76c04-41ff-4522-897f-f6bd379a35fa",
     "f5a1d57c-9c0a-4ab6-9b29-abd54acc9767",
     "5237a18e-b994-4078-8da6-dbd04f45c053",
     "6f075f28-b600-4246-8679-bc99f3b52d95",
     "6ceee960-7cf5-4404-b03e-cda11e764313",
     "87e7b625-aa80-45c4-bdb8-3d5ca89c632d",
     "c85e4b0d-5855-4935-8710-f168dbfa6642",
     "c3825c47-fc8e-40f3-9921-d236bdfa9019",
     "d0fb96c7-3081-4589-87a4-31a18b05a4dd",
     "79d661a9-d32a-4885-a2e1-568fc435d890",
     "898c68ac-4d5d-47ee-abf5-fb0e65b0ad00",
     "e01974b9-5ef6-410c-9a5d-8727923dc773",
     "d238a3a0-a46d-4955-9ca3-40dbe3a7d282",
     "f6e3d02e-d8c6-4109-9089-599202688684",
     "0597919f-842d-4d50-b21c-0b7b8ffcc6ab",
     "6ad45656-1ad0-4e6d-a8c3-617aff42cc9c",
     "e356dcbb-1616-4943-955b-fc01fd836959",
     "b4f59eb0-d916-4414-a707-fcc2382d2c12",
     "96f3ca27-13fe-468b-b53b-cfb45a49dcae",
     "b6f6e004-28dd-4967-b80e-5dcc879292be",
     "4f38e28b-2ed8-4ca9-a71e-10544c42415d",
     "4a33845f-78a8-44ab-9359-fea885cc5295",
     "8fcc8e3f-2f69-45d7-964d-06e2300b12cb",
     "209b469e-5e87-4c02-8ee0-4f317fe20dac");
     var cond=true;
     for(let ttemp ;   ttemp>avoidJobsID.length; temp++){
       if(avoidJobsID[ttemp] == JobsResult[k].id){
        cond=false ;
        break;
       }
     }
     if(cond &&  new Date (JobsResult[k].dateCreated) > new Date("2019-02-25")  ){ 
      ...
      if(docs.length>0 ){
        ...
        if(JobsResult[k].hasOwnProperty('job_active_stage') && docs[0].job_active_stage){
          ...
          // Need to berify this points   
          // JobsResult[k].Preset_Stages=[];
         // console.log("ccc===>>>", NewPreset_Stages.length , docs[0].Preset_Stages.length, NewPreset_Stages.length > docs[0].Preset_Stages.length);
          if(NewPreset_Stages.length > docs[0].Preset_Stages.length){
            //console.log("API Data=>",JobsResult[k]);
            ...
            //console.log("data changes:==>", NewPreset_Stages );
            console.log("update data is:==>", JSON.stringify( $set) ,"Where ID==>" , JobsResult[k].id );
            Mdb.bynder_jobs.updateOne({ id : JobsResult[k].id },
                { $set: $set }
              ).then((res) => {
            ...
            //console.log("datais====>", JobsResult[k]);
            var job_date_finished="", job_duration=0, stage_dateff=new Date();
              ...
              if(( docs[0].job_date_finished=="" || docs[0].job_date_finished==null ) && JobsResult[k].job_active_stage.status=="Approved"){
                   ...
                   //console.log("date_diff-----> ", new Date(), docs[0].dateCreated );
                   job_duration= dateDiffinDuration(  new Date(), docs[0].dateCreated );
                   job_durationDay= dateDiffinDuration( new Date( docs[0].dateCreated), new Date());
             }else if(JobsResult[k].job_active_stage.status!=docs[0].job_active_stage.status){
                 job_date_finished= "";
                 job_duration= dateDiffinDuration(  new Date(), docs[0].dateCreated );;
                 job_durationDay= dateDiffinDuration(  new Date(), docs[0].dateCreated );;
              }
            ...
            var $set={
                    ...
                    job_durationDay:job_durationDay
              };
              //console.log("update data is:==>",$set ,"Where ID==>" , {id : JobsResult[k].id });
              Mdb.bynder_jobs.updateOne({ id : JobsResult[k].id },
                  { $set: $set }
                ).then((Err) => {
                console.log( JobsResult[k].id,"==>",  $set);
              }).catch(() => {
                console.log("not updated bynder_jobs ID:", JobsResult[k].id);
              });
          }
        // no need un- necessary record update only update which stage change  end
      }else{
        console.log("process Saving ID: ", JobsResult[k].id);
        //var bynder_jobs=  Mdb.bynder_jobs;
        //genetate duplicate colom for jobID
        // add Start &End data with job_duration in Preset_Stages
        //var MPS_job_active_stage=JobsResult[k].job_active_stage;
        ...
        JobsResult[k].job_key="";
        JobsResult[k].job_date_finished="";
        JobsResult[k].job_duration="";
        ...
        new Mdb.bynder_jobs(JobsResult[k]).save().then((dt) => {
         console.log('business in added successfully id:'+ JobsResult[k].id );
        }).catch((Err) => {
          console.log("unable to save bynder_job id:", JobsResult[k].id );
        });
      }
   
    });
    // res.send("result data changed");
     }//END FOR 25-FEB-2019 DATE TESTING
    }
   // console.log("stage Moved count", movedCount);
